...
This simulation demonstrates the differentiating properties of blockchain such as **Immutability**, **Decentralization**, and **Performance**.
...
- Once you have successfully edited the data in the RDBMS Representation Table, click the **EDIT BLOCKCHAIN** button under the **Blockchain Representation** section.  
...
- When the server fails, try to buy a new item. A message will appear stating:  
  _“The server is currently down. Choose an option to proceed.”_  
  You will be given two options: **Fix and Continue** or **Continue Without Fix**.  

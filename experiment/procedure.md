...
Clicking on blockchain database will allow the user to view how data is stored in a blockchain database, displaying blocks with the header, hash, product name, and purchase time <div style="text-align-center;"> <img src="./images/block.png" alt="conventional database"></div>
